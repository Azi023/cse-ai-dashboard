...
export default function PerformancePage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6">
      ...
      {/* What are AI Signals? — Explanation card */}
      <Card>
        <CardContent className="pt-5 pb-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              <p className="font-medium text-foreground">What are AI Signals?</p>
              <p>
                These are theoretical trade signals generated by the strategy engine.
                They show what the AI <strong>would have recommended</strong> based on technical analysis.
                They are <strong>NOT actual trades</strong> — check the Demo Portfolio for simulated trades.
              </p>
              <ul className="space-y-1 text-xs">
                <li><strong className="text-emerald-500">BUY signals:</strong> The AI detected a buying opportunity</li>
                <li><strong className="text-muted-foreground">HOLD signals:</strong> No strong direction detected</li>
                <li><strong className="text-red-500">SELL signals:</strong> The AI detected selling pressure</li>
                <li><strong className="text-foreground">Win Rate:</strong> % of signals where the stock moved in the predicted direction within 7 days</li>
              </ul>
            </div>
          </div>
        </CardContent>
